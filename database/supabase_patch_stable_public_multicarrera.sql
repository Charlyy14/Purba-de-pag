-- =====================================================
-- EDUCLASS PATCH ESTABLE
-- Lectura pública, sesión usable, roles protegidos y cursos multicarrera
...
on public.course_careers for select to anon, authenticated
using (true);
...
on public.course_careers for all to authenticated
using (public.is_admin())
with check (public.is_admin());
